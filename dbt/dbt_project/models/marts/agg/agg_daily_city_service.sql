...
select
    ...
    {{ safe_divide('countif(is_completed)', 'count(distinct ride_id)') }} as completion_rate,
    {{ safe_divide('countif(is_cancelled)', 'count(distinct ride_id)') }} as cancellation_rate,
