...
SIM_SECONDS_PER_MINUTE = get_env_float("SIM_SECONDS_PER_MINUTE", "0.05")
RIDES_PER_MINUTE = get_env_float("RIDES_PER_MINUTE", "10")
MAX_CONCURRENT_RIDES = get_env_int("MAX_CONCURRENT_RIDES", "50")
SEED_RIDERS = get_env_int("SEED_RIDERS", "5000")
SEED_DRIVERS = get_env_int("SEED_DRIVERS", "1500")
SEED_PROMOTIONS = get_env_int("SEED_PROMOTIONS", "30")
ENABLE_MAINTENANCE_EVENTS = get_env_bool("ENABLE_MAINTENANCE_EVENTS", "true")
