...
with DAG(
    ...
    schedule=CronDataIntervalTimetable("30 22 * * *", timezone="Asia/Jakarta"), # setiap hari pada pukul 22:30 (22:30 malam)
    start_date=pendulum.datetime(2026, 4, 23, tz="Asia/Jakarta"),
    catchup=True,
    max_active_runs=1,
