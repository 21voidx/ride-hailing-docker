...
SIM_SECONDS_PER_MINUTE = float(os.getenv("SIM_SECONDS_PER_MINUTE", "0.05"))
RIDES_PER_MINUTE = float(os.getenv("RIDES_PER_MINUTE", "10"))
MAX_CONCURRENT_RIDES = int(os.getenv("MAX_CONCURRENT_RIDES", "50"))
SEED_RIDERS = int(os.getenv("SEED_RIDERS", "5000"))
SEED_DRIVERS = int(os.getenv("SEED_DRIVERS", "1500"))
SEED_PROMOTIONS = int(os.getenv("SEED_PROMOTIONS", "30"))
